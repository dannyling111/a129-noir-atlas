...
const labels={idle:'静立',walk:'漫步',run:'奔跑',float:'漂浮',reach:'伸手',wave:'挥手',point:'指向',open:'张开双臂',look:'环顾',bow:'鞠躬',crouch:'下蹲',kneel:'单膝',sit:'坐下',meditate:'盘坐',balance:'单脚平衡',stretch:'舒展',turn:'转身',dance:'轻舞',chair:'椅上坐姿',work:'办公',read:'阅读',tea:'喝茶',talk:'交谈'};
